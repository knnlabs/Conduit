...
interface ModelCostFormSectionsProps {
  form: UseFormReturnType<FormValues>;
  modelType: ModelType;
}

export function ModelCostFormSections({ form, modelType }: ModelCostFormSectionsProps) {
  return (
    <>
      {/* Basic Token Pricing for Chat/Embedding */}
      ...
      {/* Prompt Caching for Chat models */}
      {modelType === ModelType.Chat && (
        <Stack gap="sm">
