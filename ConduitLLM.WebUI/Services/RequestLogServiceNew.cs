...
using static ConduitLLM.Configuration.Services.Dtos.LogsSummaryDto;
...
public class RequestLogServiceNew : IRequestLogServiceNew
{
    ...
    private readonly ILogger<RequestLogServiceNew> _logger;
    private readonly IMemoryCache _memoryCache;

    public RequestLogServiceNew(
        IRequestLogRepository requestLogRepository,
        IVirtualKeyRepository virtualKeyRepository,
        ILogger<RequestLogServiceNew> logger,
