...
{
    /// <summary>
    /// Repository-based authentication controller
    /// </summary>
    [ApiController]
    [Route("api/[controller]")]
    public class AuthControllerNew : ControllerBase
    {
        private readonly GlobalSettingServiceNew _settingService;
        private readonly ILogger<AuthControllerNew> _logger;

        /// <summary>
        /// Creates a new instance of the AuthControllerNew
        /// </summary>
        public AuthControllerNew(
            GlobalSettingServiceNew settingService,
            ILogger<AuthControllerNew> logger)
        {
    ...
    /// </summary>
    // Using the existing LoginRequest class from AuthController
