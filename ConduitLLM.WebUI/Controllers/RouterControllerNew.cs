...
{
    /// <summary>
    /// Repository-based controller for managing router configurations and deployments
    /// </summary>
    [ApiController]
    [Route("api/[controller]")]
    public class RouterControllerNew : ControllerBase
    {
        private readonly RouterServiceNew _routerService;
        private readonly ILogger<RouterControllerNew> _logger;

        /// <summary>
        /// Creates a new instance of the RouterControllerNew with repository-based service
        /// </summary>
        public RouterControllerNew(
            RouterServiceNew routerService, 
            ILogger<RouterControllerNew> logger)
        {
