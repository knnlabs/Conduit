...
export interface UseDeleteNotificationOptions extends Omit<UseMutationOptions<void, Error, number>, 'mutationFn'> {}
...
export function useDeleteNotification(options?: UseDeleteNotificationOptions) {
  ...
  return useMutation<void, Error, number>({
    mutationFn: (notificationId: number) => adminClient.notifications.deleteNotification(notificationId),
