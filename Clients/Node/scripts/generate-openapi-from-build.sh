...
dotnet swagger tofile --output ConduitLLM.Admin/openapi.json ConduitLLM.Admin/bin/Debug/net9.0/ConduitLLM.Admin.dll v1

# The Core API already has openapi.json
echo "✅ OpenAPI specs ready!"
echo "   - Core API: ConduitLLM.Http/openapi.json"
echo "   - Admin API: ConduitLLM.Admin/openapi.json"
