...
/// <summary>
/// Interface for managing SignalR connections and health checks.
/// </summary>
public interface IConnectionService
{
    ...
    Task<bool> ConnectHubAsync(string hubName, CancellationToken cancellationToken = default);
    ...
    Task DisconnectHubAsync(string hubName, CancellationToken cancellationToken = default);
    ...
    Task<ConnectionHealth> GetConnectionHealthAsync(string hubName);
    ...
    Task<bool> IsConnectedAsync(string hubName);
