...
/// Provides admin-specific authentication using master key.
/// </summary>
public abstract class BaseSignalRConnection : IAsyncDisposable
{
    protected HubConnection? _connection;
    protected readonly string _masterKey;
    ...
    protected BaseSignalRConnection(string baseUrl, string masterKey, ILogger? logger = null)
    {
    ...
    protected virtual async Task<HubConnection> GetConnectionAsync(CancellationToken cancellationToken = default)
    {
        if (_connection == null)
        {
            ...
            _connection = new HubConnectionBuilder()
                ...
                {
                    // Add authentication via master key header
                    options.Headers.Add(HttpHeaders.MasterKey, _masterKey);
                    ...
                    // Add user agent
                    options.Headers.Add(HttpHeaders.UserAgent, "ConduitLLM.AdminClient/1.0");
                })
