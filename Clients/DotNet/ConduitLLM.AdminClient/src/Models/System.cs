...
/// <summary>
/// Represents system metrics information.
/// </summary>
public class SystemMetricsDto
{
    ...
    /// <summary>
    /// Gets or sets disk usage information.
    /// </summary>
    public DiskMetrics Disk { get; set; } = new();

    /// <summary>
    /// Gets or sets network usage information.
    /// </summary>
...
/// <summary>
/// Represents disk usage metrics.
/// </summary>
public class DiskMetrics
{
    /// <summary>
    /// Gets or sets total disk space in bytes.
    /// </summary>
    public long TotalBytes { get; set; }

    /// <summary>
    /// Gets or sets used disk space in bytes.
    /// </summary>
    public long UsedBytes { get; set; }

    /// <summary>
    /// Gets or sets available disk space in bytes.
    /// </summary>
    public long AvailableBytes { get; set; }
...
public class NetworkMetrics
{
    ...
    /// <summary>
    /// Gets or sets packets sent.
    /// </summary>
    public long PacketsSent { get; set; }

    /// <summary>
    /// Gets or sets packets received.
    /// </summary>
