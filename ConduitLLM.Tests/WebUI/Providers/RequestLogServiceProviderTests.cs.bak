...
{
    public class RequestLogServiceProviderTests
    {
        private readonly Mock<IAdminApiClient> _adminApiClientMock;
        private readonly Mock<ILogger<RequestLogServiceProvider>> _loggerMock;
        private readonly RequestLogServiceProvider _provider;

        public RequestLogServiceProviderTests()
        {
            _adminApiClientMock = new Mock<IAdminApiClient>();
            _loggerMock = new Mock<ILogger<RequestLogServiceProvider>>();
            _provider = new RequestLogServiceProvider(_adminApiClientMock.Object, _loggerMock.Object);
        }
        ...
        public async Task CreateRequestLogAsync_ReturnsLog_WhenCreationSucceeds()
        {
            ...
            _adminApiClientMock.Setup(c => c.CreateRequestLogAsync(It.IsAny<RequestLogDto>()))
                .ReturnsAsync(requestLogDto);

            // Act
            var result = await _provider.CreateRequestLogAsync(
                virtualKeyId,
                modelName,
                requestType,
                inputTokens,
            ...
            _adminApiClientMock.Verify(c => c.CreateRequestLogAsync(It.Is<RequestLogDto>(dto =>
        ...
        public async Task GetAllKeysUsageSummaryAsync_ReturnsKeySummaries_WhenApiReturnsData()
        {
            ...
            // Act
            var result = await _provider.GetAllKeysUsageSummaryAsync();
        ...
        public async Task GetDailyUsageStatsAsync_ReturnsDailyStats_WhenApiReturnsData()
        {
            ...
            // Act
            var result = await _provider.GetDailyUsageStatsAsync(virtualKeyId, startDate, endDate);
        ...
        public async Task GetDistinctModelsAsync_ReturnsModels_WhenApiReturnsData()
        {
            ...
            // Act
            var result = await _provider.GetDistinctModelsAsync();
        ...
        public async Task GetKeyUsageSummaryAsync_ReturnsUsageSummary_WhenKeyExists()
        {
            ...
            _adminApiClientMock.Setup(c => c.GetVirtualKeyByIdAsync(virtualKeyId))
                .ReturnsAsync(virtualKey);
                
            _adminApiClientMock.Setup(c => c.GetVirtualKeyUsageStatisticsAsync(virtualKeyId))
                .ReturnsAsync(keyUsageStats);
                
            _adminApiClientMock.Setup(c => c.GetLogsSummaryAsync(7, virtualKeyId))
                .ReturnsAsync(logsSummary7Days);
                
            _adminApiClientMock.Setup(c => c.GetLogsSummaryAsync(1, virtualKeyId))
                .ReturnsAsync(logsSummary1Day);
                
            _adminApiClientMock.Setup(c => c.GetLogsSummaryAsync(30, virtualKeyId))
                .ReturnsAsync(logsSummary30Days);

            // Act
            var result = await _provider.GetKeyUsageSummaryAsync(virtualKeyId);
            ...
            _adminApiClientMock.Verify(c => c.GetVirtualKeyByIdAsync(virtualKeyId), Times.Once);
            _adminApiClientMock.Verify(c => c.GetVirtualKeyUsageStatisticsAsync(virtualKeyId), Times.Once);
            _adminApiClientMock.Verify(c => c.GetLogsSummaryAsync(7, virtualKeyId), Times.Once);
            _adminApiClientMock.Verify(c => c.GetLogsSummaryAsync(1, virtualKeyId), Times.Once);
            _adminApiClientMock.Verify(c => c.GetLogsSummaryAsync(30, virtualKeyId), Times.Once);
        }
        ...
        public async Task GetRequestLogsForKeyAsync_ReturnsLogs_WhenApiReturnsData()
        {
            ...
            _adminApiClientMock.Setup(c => c.GetRequestLogsAsync(page, pageSize, virtualKeyId, null, null, null))
                .ReturnsAsync(pagedResult);

            // Act
            var (result, totalCount) = await _provider.GetRequestLogsForKeyAsync(virtualKeyId, page, pageSize);
            ...
            _adminApiClientMock.Verify(c => c.GetRequestLogsAsync(page, pageSize, virtualKeyId, null, null, null), Times.Once);
        }
        ...
        public async Task SearchLogsAsync_ReturnsLogs_WhenApiReturnsData()
        {
            ...
            // Act
            var (result, totalCount) = await _provider.SearchLogsAsync(
        ...
        public async Task GetLogsSummaryAsync_ReturnsSummary_WhenApiReturnsData()
        {
            ...
            _adminApiClientMock.Setup(c => c.GetLogsSummaryAsync(days))
                .ReturnsAsync(configSummary);

            // Act
            var result = await _provider.GetLogsSummaryAsync(startDate, endDate);
            ...
            _adminApiClientMock.Verify(c => c.GetLogsSummaryAsync(days), Times.Once);
        }
    }
}