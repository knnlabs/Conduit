...
namespace ConduitLLM.Tests.Core.Providers
{
    /// <summary>
    ...
    public class BaseProviderMetadataTests
    {
        ...
        // These tests are commented out because CreateApiKeyField and CreateUrlField are protected methods
        // and cannot be accessed directly from tests. These methods are tested indirectly through
        // the provider metadata implementations that use them.
