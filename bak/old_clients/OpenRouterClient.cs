...
using ConduitLLM.Providers.InternalModels.OpenAIModels; // Added for OpenAI models
...
namespace ConduitLLM.Providers
{
    ...
    public class OpenRouterClient : ILLMClient
    {
        ...
        public Task<Core.Models.EmbeddingResponse> CreateEmbeddingAsync(Core.Models.EmbeddingRequest request, string? apiKey = null, CancellationToken cancellationToken = default)
            => Task.FromException<Core.Models.EmbeddingResponse>(new NotSupportedException("Embeddings are not supported by OpenRouterClient."));

        public Task<Core.Models.ImageGenerationResponse> CreateImageAsync(Core.Models.ImageGenerationRequest request, string? apiKey = null, CancellationToken cancellationToken = default)
            => Task.FromException<Core.Models.ImageGenerationResponse>(new NotSupportedException("Image generation is not supported by OpenRouterClient."));
