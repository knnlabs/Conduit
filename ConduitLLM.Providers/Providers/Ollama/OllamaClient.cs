...
using ConduitLLM.Providers.Providers.Ollama.Models;
using ConduitLLM.Providers.Utilities;

using Microsoft.Extensions.Logging;

namespace ConduitLLM.Providers.Providers.Ollama
{
    /// <summary>
    ...
    public class OllamaClient : CustomProviderClient
    {
        ...
        private ConduitLLM.Providers.Common.Models.ModelCapabilities DetermineModelCapabilities(OllamaModelInfo modelInfo)
        {
            var capabilities = new ConduitLLM.Providers.Common.Models.ModelCapabilities
            {
