    ...
    public class VertexAIClient : CustomProviderClient
    {
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(_projectId))
                {
                    return Core.Interfaces.AuthenticationResult.Failure("Google Cloud project ID is required");
                }
                ...
                {
                    return Core.Interfaces.AuthenticationResult.Failure("Invalid or expired API key");
                }
