...
namespace ConduitLLM.Admin.Controllers
{
    ...
    public class AudioConfigurationController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(ConduitLLM.Configuration.DTOs.Audio.AudioKeyUsageDto), 200)]
        ...
        [ProducesResponseType(typeof(ConduitLLM.Configuration.DTOs.Audio.AudioProviderUsageDto), 200)]
