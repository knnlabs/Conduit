...
declare class FetchAnalyticsService {
     ...
     */
    getCostSummary(startDate?: string, endDate?: string, config?: RequestConfig): Promise<CostSummaryDto>;
    /**
     * Get cost by period (legacy endpoint)
     */
    getCostByPeriod(period: 'hour' | 'day' | 'week' | 'month', startDate?: string, endDate?: string, config?: RequestConfig): Promise<CostByPeriodDto>;
    /**
...
export { type IpFilterStatistics as $, type AudioConfigurationDto as A, type BulkMappingRequest as B, type ConfigValue as C, type DiscoveredModel as D, type ExportDestinationConfig as E, FetchBaseApiClient as F, type GlobalSettingDto as G, type SystemConfiguration as H, type CreateIpFilterDto as I, type IpFilterDto as J, type IpFilterFilters as K, type UpdateIpFilterDto as L, type ModelProviderMappingDto as M, type IpFilterSettingsDto as N, type UpdateIpFilterSettingsDto as O, type ProviderCredentialDto as P, type IpCheckResult as Q, type RouterConfigurationDto as R, type SettingFilters as S, type FilterType as T, type UpdateProviderCredentialDto as U, type VirtualKeyMetadata as V, type BulkOperationResult as W, type CreateTemporaryIpFilterDto as X, type IpFilterImport as Y, type IpFilterImportResult as Z, type BlockedRequestStats as _, type ExtendedMetadata as a, type TestResult as a$, type BulkIpFilterResponse as a0, type IpFilterValidationResult as a1, type CreateModelCostDto as a2, type ModelCost as a3, type PagedResult as a4, type ModelCostFilters as a5, type ModelCostDto as a6, type UpdateModelCostDto as a7, type ModelCostCalculation as a8, type ImportResult as a9, type RunMaintenanceTaskRequest as aA, type MaintenanceTaskResult as aB, type AuditLogFilters as aC, type AuditLogDto as aD, type DiagnosticChecks as aE, type FeatureAvailability as aF, type ApiClientConfig as aG, type CreateProviderHealthConfigurationDto as aH, type ProviderHealthStatisticsDto as aI, type ProviderStatus as aJ, type UpdateNotificationDto as aK, NotificationType as aL, NotificationSeverity as aM, type NotificationStatistics as aN, type NotificationBulkResponse as aO, type NotificationFilters as aP, type NotificationSummary as aQ, type SecurityEventFilters as aR, type SecurityEvent as aS, type CreateSecurityEventDto as aT, type ThreatFilters as aU, type ThreatDetection as aV, type ThreatAction as aW, type ThreatAnalytics as aX, type ComplianceMetrics as aY, type RoutingConfiguration as aZ, type UpdateRoutingConfigDto as a_, type ModelCostOverview as aa, type CostTrend as ab, type BulkModelCostUpdate as ac, type ModelCostHistory as ad, type CostEstimate as ae, type ModelCostComparison as af, type CostSummaryDto as ag, type CostByPeriodDto as ah, type ModelUsageDto as ai, type KeyUsageDto as aj, type RequestLogFilters as ak, type RequestLogDto as al, type UsageMetricsDto as am, type AnalyticsFilters as an, type CostForecastDto as ao, type AnomalyDto as ap, type AnalyticsOptions as aq, type SystemInfoDto as ar, type HealthStatusDto as as, type BackupDto as at, type CreateBackupRequest as au, type RestoreBackupRequest as av, type BackupRestoreResult as aw, type NotificationDto as ax, type CreateNotificationDto as ay, type MaintenanceTaskDto as az, type CreateProviderCredentialDto as b, type SettingUpdate as b$, type LoadBalancerHealth as b0, type CachingConfiguration as b1, type UpdateCachingConfigDto as b2, type CachePolicy as b3, type CreateCachePolicyDto as b4, type UpdateCachePolicyDto as b5, type CacheRegion as b6, type ClearCacheResult as b7, type CacheStatistics as b8, type RoutingConfigDto as b9, type UpdateCacheConfigDto as bA, type CacheRule as bB, type CacheCondition as bC, type CacheClearParams as bD, type CacheClearResult as bE, type CacheStatsDto as bF, type CacheKeyStats as bG, type LoadBalancerConfigDto as bH, type UpdateLoadBalancerConfigDto as bI, type LoadBalancerNode as bJ, type PerformanceConfigDto as bK, type UpdatePerformanceConfigDto as bL, type PerformanceTestParams as bM, type PerformanceTestResult as bN, type PerformanceDataPoint as bO, type ErrorSummary as bP, type FeatureFlag as bQ, type FeatureFlagCondition as bR, type UpdateFeatureFlagDto as bS, type ModelProviderInfo as bT, type ModelCapabilities$1 as bU, FetchVirtualKeyService as bV, FetchProvidersService as bW, FetchSystemService as bX, FetchModelMappingsService as bY, FetchProviderModelsService as bZ, FetchSettingsService as b_, type UpdateRoutingConfigDto$1 as ba, type RoutingRule$1 as bb, type CreateRoutingRuleDto as bc, type UpdateRoutingRuleDto as bd, type LoadBalancerHealthDto as be, FetchConduitAdminClient as bf, type IpWhitelistDto as bg, type IpEntry as bh, type SecurityEventParams as bi, type SecurityEventType as bj, type SecurityEventExtended as bk, type SecurityEventPage as bl, type ThreatSummaryDto as bm, type ThreatCategory as bn, type ActiveThreat as bo, type AccessPolicy as bp, type PolicyRule as bq, type CreateAccessPolicyDto as br, type UpdateAccessPolicyDto as bs, type AuditLogParams as bt, type AuditLog as bu, type AuditLogPage as bv, type RetryPolicy as bw, type RuleCondition as bx, type RuleAction as by, type CacheConfigDto as bz, type ProviderFilters as c, type ThroughputMetric as c$, type SettingsDto as c0, type SettingsListResponseDto as c1, FetchAnalyticsService as c2, FetchProviderHealthService as c3, FetchSecurityService as c4, FetchConfigurationService as c5, FetchMonitoringService as c6, FetchIpFilterService as c7, FetchErrorQueueService as c8, FetchCostDashboardService as c9, type components as cA, type operations as cB, type paths as cC, type Logger as cD, type CacheProvider as cE, HttpError as cF, type SignalRConfig as cG, type RequestConfigInfo as cH, type RetryConfig as cI, type ConduitConfig as cJ, type RequestConfig as cK, type ResponseInfo as cL, StatusType as cM, type ModelDto as cN, type ModelDetailsDto as cO, type ModelExample as cP, type ModelSearchFilters as cQ, type ModelSearchResult as cR, type ModelListResponseDto as cS, type RefreshModelsRequest as cT, type RefreshModelsResponse as cU, type HealthSummaryDto as cV, type ProviderHealthSummary as cW, type ProviderHealthDto as cX, type HealthCheck as cY, type UptimeMetric as cZ, type LatencyMetric as c_, FetchModelCostService as ca, type CostDashboardDto as cb, type ModelCostDto$1 as cc, type ProviderCostDto as cd, type DailyCostDto as ce, type CostTrendDto as cf, type ModelCostDataDto as cg, type VirtualKeyCostDataDto as ch, type ErrorQueueInfo as ci, type ErrorQueueSummary as cj, type ErrorQueueListResponse as ck, type ErrorMessage as cl, type ErrorMessageDetail as cm, type ErrorDetails as cn, type ErrorMessageListResponse as co, type ErrorRateTrend as cp, type FailingMessageType as cq, type QueueGrowthPattern as cr, type ErrorQueueStatistics as cs, type HealthStatusCounts as ct, type HealthIssue as cu, type ErrorQueueHealth as cv, type QueueClearResponse as cw, type MessageReplayResponse as cx, type MessageDeleteResponse as cy, AudioConfigurationService as cz, type ProviderConnectionTestResultDto as d, type QuotaAlert as d$, type ErrorMetric as d0, type HistoryParams as d1, type HealthHistory as d2, type HealthDataPoint as d3, type AlertParams as d4, type HealthAlert as d5, type ConnectionTestResult as d6, type PerformanceParams as d7, type PerformanceMetrics$1 as d8, type ErrorTypeCount as d9, type VirtualKeyUsage as dA, type ModelUsage as dB, type TimeSeriesData as dC, type VirtualKeyParams as dD, type VirtualKeyAnalytics as dE, type VirtualKeyUsageSummary as dF, type VirtualKeyRanking as dG, type TrendData as dH, type CapabilityUsage as dI, type ModelPerformanceMetrics as dJ, type ExportParams$1 as dK, type ExportResult$1 as dL, type TimeSeriesDataPoint as dM, type ProviderUsageBreakdown as dN, type ModelUsageBreakdown as dO, type VirtualKeyUsageBreakdown as dP, type EndpointUsageBreakdown as dQ, type RequestLogStatisticsParams as dR, type ServiceHealthMetrics as dS, type QueueMetrics as dT, type DatabaseMetrics as dU, type SystemAlert as dV, type ProviderHealthDetails as dW, type EndpointHealth as dX, type HealthHistoryPoint as dY, type ProviderIncident as dZ, type VirtualKeyDetail as d_, type Incident as da, type MaintenanceWindow as db, type HealthAlertListResponseDto as dc, type ProviderHealthListResponseDto as dd, type ProviderHealthStatusResponse as de, type ProviderHealthItem as df, type ProviderWithHealthDto as dg, type ProviderHealthMetricsDto as dh, type ProviderEndpointHealth as di, type ProviderModelHealth as dj, type ProviderHealthIncident as dk, type ProviderHealthHistoryOptions as dl, type ProviderHealthHistoryResponse as dm, type ProviderHealthDataPoint as dn, type SettingCategory as dp, type RouterCondition as dq, type RouterAction as dr, type FilterMode as ds, type IpCheckRequest as dt, type BulkIpFilterRequest as du, type RequestLogParams as dv, type RequestLogPage as dw, type UsageParams as dx, type UsageAnalytics as dy, type ProviderUsage as dz, type ProviderConnectionTestRequest as e, type TraceQueryParams as e$, type SystemHealthDto as e0, type SystemMetricsDto as e1, type ServiceStatusDto as e2, type HealthEventDto as e3, type HealthEventsResponseDto as e4, type HealthEventSubscriptionOptions as e5, type HealthEventSubscription as e6, type AudioProviderConfigRequest as e7, type AudioProviderConfigDto as e8, type AudioCostConfigRequest as e9, type AlertTriggerType as eA, type AlertDto as eB, type AlertCondition as eC, type AlertAction as eD, type CreateAlertDto as eE, type UpdateAlertDto as eF, type AlertHistoryEntry as eG, type DashboardDto as eH, type DashboardLayout as eI, type DashboardWidget as eJ, type WidgetPosition as eK, type WidgetConfig as eL, type WidgetDataSource as eM, type CreateDashboardDto as eN, type UpdateDashboardDto as eO, type SystemResourceMetrics as eP, type MonitoringCpuMetrics as eQ, type CpuCoreMetrics as eR, type MonitoringMemoryMetrics as eS, type DiskMetrics as eT, type DiskDeviceMetrics as eU, type NetworkMetrics as eV, type NetworkInterfaceMetrics as eW, type ProcessMetrics as eX, type TraceDto as eY, type SpanDto as eZ, type SpanLog as e_, type AudioCostConfigDto as ea, type AudioUsageDto as eb, type AudioUsageSummaryDto as ec, type AudioKeyUsageDto as ed, type AudioProviderUsageDto as ee, type AudioOperationUsageDto as ef, type RealtimeSessionDto as eg, type RealtimeSessionMetricsDto as eh, type AudioProviderTestResult as ei, type AudioUsageFilters as ej, type AudioUsageSummaryFilters as ek, AudioOperationTypes as el, type AudioOperationType as em, AudioUnitTypes as en, type AudioUnitType as eo, AudioCurrencies as ep, type AudioCurrency as eq, validateAudioProviderRequest as er, validateAudioCostConfigRequest as es, validateAudioUsageFilters as et, type MetricDataPoint as eu, type MetricTimeSeries as ev, type MetricsQueryParams as ew, type MetricsResponse as ex, type AlertSeverity as ey, type AlertStatus as ez, type ProviderHealthConfigurationDto as f, type LogEntry as f0, type LogQueryParams as f1, type LogStreamOptions as f2, type MonitoringHealthStatus as f3, type ServiceHealthStatus as f4, type MetricExportParams as f5, type MetricExportResult as f6, type ExportFormat as f7, type RoutingRule as f8, type ProviderPriority as f9, type SystemParameters as fA, type Metadata as fB, type CustomSettings as fC, type ValidationFunction as fD, type EventData as fE, type RouterActionParameters as fF, type MaintenanceTaskConfig as fG, type MaintenanceTaskResultData as fH, type MetricDimensions as fI, type AdditionalProviderInfo as fJ, type CacheNode as fa, type RegionStatistics as fb, type EndpointStatistics as fc, type StatisticPoint as fd, type BaseMetadata as fe, type ProviderConfigMetadata as ff, type AnalyticsMetadata as fg, type AlertMetadata as fh, type SecurityEventMetadata as fi, type ExportConfigMetadata as fj, type ModelConfigMetadata as fk, type AudioConfigMetadata as fl, type VideoGenerationMetadata as fm, isValidMetadata as fn, parseMetadata as fo, stringifyMetadata as fp, type FeatureFlagContext as fq, type ProviderSettings as fr, type AudioProviderSettings as fs, type ModelQueryParams as ft, type DiagnosticResult as fu, type SessionMetadata as fv, type MonitoringFields as fw, type HealthCheckDetails as fx, type SecurityEventDetails as fy, type SecurityChangeRecord as fz, type UpdateProviderHealthConfigurationDto as g, type ProviderHealthSummaryDto as h, type ProviderHealthStatusDto as i, type ProviderHealthFilters as j, type ProviderHealthRecordDto as k, type ProviderUsageStatistics as l, type ProviderDataDto as m, type CreateModelProviderMappingDto as n, type ModelMappingFilters as o, type UpdateModelProviderMappingDto as p, type BulkMappingResponse as q, type CapabilityTestResult as r, type ModelRoutingInfo as s, type ModelMappingSuggestion as t, type CreateGlobalSettingDto as u, type UpdateGlobalSettingDto as v, type CreateAudioConfigurationDto as w, type UpdateAudioConfigurationDto as x, type UpdateRouterConfigurationDto as y, type RouterRule as z };
