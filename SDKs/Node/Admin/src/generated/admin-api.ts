...
export interface paths {
    ...
    "/api/prompt-caching/config": {
        ...
        get: {
            ...
            responses: {
                ...
                /** @description Stored prompt caching configuration is invalid or uses an unsupported schema version. */
                409: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/prompt-caching/capabilities": {
        ...
        /** Gets provider and model prompt caching capabilities. */
        get: {
            parameters: {
                query?: never;
                header?: never;
...
export interface components {
    schemas: {
        ...
        /** @enum {unknown} */
        ApiKeyTestResult: "Success" | "InvalidKey" | "Ignored" | "ProviderDown" | "RateLimited" | "UnknownError";
        /** @description Application identity information. */
        ApplicationInfoDto: {
        ...
        MediaCleanupStatusDto: {
             ...
             */
            maxBatchSize?: number;
            defaultRetentionPolicy?: null | components["schemas"]["RetentionPolicySummaryDto"];
            /**
             * Format: int32
        ...
        VirtualKeyGroup: {
            ...
            mediaRetentionPolicy?: null | components["schemas"]["MediaRetentionPolicy"];
