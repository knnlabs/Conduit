...
namespace ConduitLLM.Providers
{
    ...
    /// </summary>
    [Obsolete("External model discovery is no longer used. The Provider Models endpoint now returns models from the local database based on provider type compatibility. This service will be removed in a future version.")]
