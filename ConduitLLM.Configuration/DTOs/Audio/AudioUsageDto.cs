...
namespace ConduitLLM.Configuration.DTOs.Audio
{
    ...
    /// <summary>
    /// DTO for audio usage by virtual key.
    /// </summary>
    ...
    /// <summary>
    /// DTO for audio usage by provider.
    /// </summary>
    public class AudioProviderUsageDto
    {
        ...
        /// <summary>
        /// Top virtual keys using this provider.
        /// </summary>
        public List<VirtualKeyBreakdown> TopVirtualKeys { get; set; } = new();
