...
namespace ConduitLLM.Configuration.Repositories
{
    ...
    public interface IAudioUsageLogRepository
    {
        ...
        /// </summary>
        Task<List<AudioUsageLog>> GetByProviderAsync(string provider, DateTime? startDate = null, DateTime? endDate = null);
        ...
        /// </summary>
        Task<List<VirtualKeyBreakdown>> GetVirtualKeyBreakdownAsync(DateTime startDate, DateTime endDate, string? provider = null);
