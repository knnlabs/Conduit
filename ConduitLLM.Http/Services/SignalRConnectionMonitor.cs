...
using SignalRConnectionInfo = ConduitLLM.Http.Models.ConnectionInfo;
...
namespace ConduitLLM.Http.Services
{
    ...
    public interface ISignalRConnectionMonitor
    {
        ...
        /// </summary>
        ConduitLLM.Http.Models.ConnectionInfo? GetConnection(string connectionId);

        /// <summary>
        /// Gets all active connections
        /// </summary>
        IEnumerable<ConduitLLM.Http.Models.ConnectionInfo> GetActiveConnections();

        /// <summary>
        /// Gets connections for a specific hub
        /// </summary>
        IEnumerable<ConduitLLM.Http.Models.ConnectionInfo> GetHubConnections(string hubName);

        /// <summary>
        /// Gets connections for a specific virtual key
        /// </summary>
        IEnumerable<ConduitLLM.Http.Models.ConnectionInfo> GetVirtualKeyConnections(int virtualKeyId);

        /// <summary>
        /// Gets connections in a specific group
        /// </summary>
        IEnumerable<ConduitLLM.Http.Models.ConnectionInfo> GetGroupConnections(string groupName);
