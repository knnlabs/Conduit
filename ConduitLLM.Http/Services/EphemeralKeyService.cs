...
namespace ConduitLLM.Http.Services
{
    ...
    public interface IEphemeralKeyService
    {
        ...
        Task<EphemeralKeyResponse> CreateEphemeralKeyAsync(int virtualKeyId, EphemeralKeyMetadata? metadata = null);
    ...
    public class EphemeralKeyService : IEphemeralKeyService
    {
        ...
        public async Task<EphemeralKeyResponse> CreateEphemeralKeyAsync(int virtualKeyId, EphemeralKeyMetadata? metadata = null)
        {
